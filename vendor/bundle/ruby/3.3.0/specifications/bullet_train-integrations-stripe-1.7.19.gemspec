# -*- encoding: utf-8 -*-
# stub: bullet_train-integrations-stripe 1.7.19 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<stripe>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<omniauth>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<omniauth-stripe-connect>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<omniauth-rails_csrf_protection>.freeze, [">= 0".freeze])
end
